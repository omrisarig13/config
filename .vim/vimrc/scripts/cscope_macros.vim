...
if has("cscope")
    ...
    nmap <leader>nns :scs find s <C-R>=expand("<cword>")<CR><CR>	
    nmap <leader>nng :scs find g <C-R>=expand("<cword>")<CR><CR>	
    nmap <leader>nnc :scs find c <C-R>=expand("<cword>")<CR><CR>	
    nmap <leader>nnt :scs find t <C-R>=expand("<cword>")<CR><CR>	
    nmap <leader>nne :scs find e <C-R>=expand("<cword>")<CR><CR>	
    nmap <leader>nnf :scs find f <C-R>=expand("<cfile>")<CR><CR>	
    nmap <leader>nni :scs find i <C-R>=expand("<cfile>")<CR><CR>	
    nmap <leader>nnd :scs find d <C-R>=expand("<cword>")<CR><CR>	


    " Hitting CTRL-space *twice* before the search type does a vertical 
    " split instead of a horizontal one (vim 6 and up only)

    nmap <C-m>s :vert scs find s <C-R>=expand("<cword>")<CR><CR>	
    nmap <C-m>g :vert scs find g <C-R>=expand("<cword>")<CR><CR>	
    nmap <C-m>c :vert scs find c <C-R>=expand("<cword>")<CR><CR>	
    nmap <C-m>t :vert scs find t <C-R>=expand("<cword>")<CR><CR>	
    nmap <C-m>e :vert scs find e <C-R>=expand("<cword>")<CR><CR>	
    nmap <C-m>f :vert scs find f <C-R>=expand("<cfile>")<CR><CR>	
    nmap <C-m>i :vert scs find i <C-R>=expand("<cfile>")<CR><CR>	
    nmap <C-m>d :vert scs find d <C-R>=expand("<cword>")<CR><CR>	
